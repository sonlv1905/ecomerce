<div class="span9">
 ...
 -->
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="address" placeholder="Adress"> <span>Street
			...
			<div class="control-group">
				...
				<div class="controls">
					<select id="state">
						<option value="">-</option>
						<option value="1">Dong Anh</option>
						<option value="2">Nam Tu Liem</option>
						<option value="3">Long Bien</option>
						<option value="4">Cau Giay</option>
						<option value="5">Ha Dong</option>
			...
			<div class="control-group">
				<div class="controls">
					<input type="hidden" name="email_create" value="1"> <input
						...
						class="btn btn-large btn-success" type="submit" value="Register">
				</div>
			</div>
		</form>
	</div>
